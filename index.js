...
function askUserForHoroscopeSign() {
  ...
  var lionDescription = 'Lav je egocentričan, voli sjaj, voli da se prikazuje, potrebno mu je uvažavanje i obožavanje. U redu, ali ima tu i mnogo više od toga. Lavovi su posvećeni i odani prijatelji, veoma darežljivi i širokogrudi kad treba da pomognu bliskoj osobi, čak i na svoju štetu. I on to ne radi da bi dobio pohvalu i poštovanje, to se prosto spontano dešava.';
  var virgoDescription = "Analitične, ozbiljne, sitničave i hladne Device takođe važe za egocentrične i naporne osobe. Ali, Devica je jedan od najbrižnijih i najpažljivijih znakova u horoskopu. Ona se iskreno i predano brine o ljudima u svom životu, samo što tu brigu ne izražava na emotivan, nego na mnogo praktičniji i logičniji način. Devica je tu da pruži svaku podršku i da vas iznenadi svojom lojalnošću i razumevanjem."; 
  var libraDescription = 'Kad imate posla sa Vagom, ponekad ćete videti kako njen napor da postigne ravnotežu i osvoji lepe i pozitivne stvari u životu postaje očajanje kad ne dobije ono što želi, i kako se zatim preusmerava na novi cilj. Vaga je međutim, vrlo promišljena i sve radi sa namerom. Teško joj je da se prepusti u potpunosti, ne zato što se plaši ili nema kapacitete, već zato što želi da donese najbolju moguću odluku. Zato će uzeti koliko god joj vremena treba, da bi bila sigurna da radi pravu stvar.';
  var scorpioDescription = "Škorpije nose etiketu teških mračnjaka, a svojim ponašanjem je i zaslužuju – ali to je test hrabrosti. Ko ima petlje da priđe bliže i pogleda dublje, otkriće najromantičniju i najzanimljiviju osobu koju je ikada upoznao. Za Škorpiju, život je prekratak, da bi ga traćila na bilo šta što ne angažuje njenu strastvenost i posvećeneost. Ona je intenzivna – na najbolji način.";
  var sagittariusDescription = "Dragi, veseli, pozitivac, okružen masom ljudi, duša zabave – to je Strelac kako ga drugi vide. Iznutra, on je dubok i promišljen i često ne pokazuje svoja osećanja jer se plaši odbijanja, a kad se nekome otvori, to znači da se uverio da će biti shvaćen i prihvaćen takav kakav je. Strelac ima velike snove i bujnu maštu i specifične stavove o svetu koji ga okružuje, i ako sa nekim to podeli, želi da bude poštovan i shvaćen.";
  var capricornDescription = "Sposobni i vredni Jarac deluje ograničen svojim visokim standardima i kriterijumima – fokusiran, organizovan i ambiciozan, Jarac ne skreće pogled sa cilja i svi mu se sklanjaju s puta, nastojeći da mu ne smetaju, ubeđeni da to što bi oni hteli da podele, Jarčevima uopšte nije ni važno, ni zanimljivo. Jarčevi bi voleli kad bi ljudi oko njih razumeli njihovu osetljivost, ali oni prosto ne mogu da je pokažu i rizikuju da ne dobiju to razumevanje i podršku, koji su im potrebni. Da bi se Jarac otvorio, potrebno mu je da ima potpuno povrenje u vas.";
